...
<div id="containerHolder">
    <div id="container">
        <div id="sidebar">
            <ul class="sideNav">
                <li><a <?php if (isset($_GET['page']) && $_GET['page'] == "home") echo 'class="active"'; ?> href="index.php?page=home">Home</a></li>
                <li><a <?php if (isset($_GET['page']) && $_GET['page'] == "overview") echo 'class="active"'; ?> href="index.php?page=overview">System&uuml;bersicht</a></li>
                <li><a <?php if (isset($_GET['page']) && $_GET['page'] == "panel") echo 'class="active"'; ?> href="index.php?page=panel">QuickPanel</a></li>
                <li><a <?php if (isset($_GET['page']) && $_GET['page'] == "stats") echo 'class="active"'; ?> href="index.php?page=stats">Serverstatistiken</a></li>
                <li><a <?php if (isset($_GET['page']) && $_GET['page'] == "doku") echo 'class="active"'; ?> href="index.php?page=doku">Dokumentation</a></li>
                <li><a <?php if (isset($_GET['page']) && $_GET['page'] == "help") echo 'class="active"'; ?> href="index.php?page=help">Hilfe</a></li>
                <li><a <?php if (isset($_GET['page']) && $_GET['page'] == "about") echo 'class="active"'; ?> href="index.php?page=about">&Uuml;ber SAS</a></li>
        ...
        <h2><a href="index.php?page=overview">Start</a> &raquo; 
            ...
            else if (isset($_GET['page']) && $_GET['page'] == "overview")
                echo '<a href="index.php?page=overview" class="active">System&uuml;bersicht</a>';
            else if (isset($_GET['page']) && $_GET['page'] == "panel")
            ...
            else if (isset($_GET['page']) && $_GET['page'] == "doku")
                echo '<a href="index.php?page=doku" class="active">Dokumentation</a>';
            else if (isset($_GET['page']) && $_GET['page'] == "help")
