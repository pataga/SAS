...
<body>
	<div id="wrapper">
        ...
        <ul id="mainNav">
        	...
        	<li><a href="ftp.html" class="active">FTP</a></li>
        ...
        <div id="containerHolder">
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                    	<li><a href="#" class="active">FTP-Server &Uuml;bersicht</a></li>
                    	<li><a href="#">FTP-Server Steuerung</a></li>
						<li><a href="#">Statistiken</a></li>
                    	<li><a href="#">Konfiguration</a></li>
                    	<li><a href="#">FTP-User</a></li>
                    	<li><a href="#">FTP-Verzeichnisse</a></li>
						<li><a href="#">?</a></li>
