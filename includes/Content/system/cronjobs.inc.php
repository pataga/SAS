...
<fieldset>
    ...
    <form action="?p=system&s=cronjobs" method="post">
        <span style="font-size: 16px; font-weight: bold; margin-right: 20px;">Kommando</span> <input type="text" name="cmd" class="text-long-ext"/><br><hr><br>
        ...
        <input type="reset" value="Einstellungen zur&uuml;cksetzen" class="button black"/>
    </form>
</fieldset>
