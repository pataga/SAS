...
<body>
	<div id="wrapper">
        ...
        <ul id="mainNav">
        	<li><a href="index.html" class="active">START</a></li> <!-- Use the "active" class for the active menu item  -->
			...
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
						...
						<li><center><i><a href="#"> - - - Entwicklungslinks - - - </a></i></center></li>
						<li><a href="example.html" class="active">Template Funktionen</a></li>
