...
<body>
	<div id="wrapper">
        ...
        <ul id="mainNav">
			...
			<li><a href="samba.html" class="active">SAMBA</a></li>
        ...
        <div id="containerHolder">
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                    	<li><a href="#" class="active">Sambaserver &Uuml;bersicht</a></li>
                    	<li><a href="#">Serverstatistiken</a></li>
                    	<li><a href="#">Steuerung</a></li>
						<li><a href="#">Konfiguration</a></li>
                    	<li><a href="#">Globale Variablen</a></li>
                    	<li><a href="#">Freigaben</a></li>
						<li><a href="#">Drucker</a></li>
						<li><a href="#">Passw&ouml;rter</a></li>
						<li><a href="#">Drucker</a></li>
